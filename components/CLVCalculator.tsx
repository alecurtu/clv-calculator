  ...
  return (
    <div className="space-y-6">
      ...
      <p className="mt-6 text-xs text-slate-500">
        This tool is for informational purposes only and not financial advice. Odds conversion uses standard American ↔ implied probability formulas.
        The "cents per half-point" model is a linear approximation; real markets vary by key numbers, vig, and book microstructure.
      </p>
    </div>
  );
}
